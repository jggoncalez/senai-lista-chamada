...
<div
	class="flex h-full w-full flex-col gap-3 rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md"
>
	...
	<div class="flex flex-1 flex-col gap-3">
		...
		<p class="text-md text-left font-bold">{nomeTurma}</p>
		<div class="flex flex-row items-center gap-2 p-0">
			<p class="w-20 rounded-xl bg-gray-200 p-1 text-center text-sm font-normal">
				{codTurma[0]}ºTermo
			</p>
			<p class="flex flex-row items-center gap-1 text-sm font-normal">
				<svg
	...
	<div class="flex flex-col gap-2 pt-2">
		...
		<a
			href="/relatorio"
			class="flex h-10 w-full items-center justify-center rounded border border-gray-200 bg-white font-medium text-gray-600 transition-colors hover:bg-gray-100"
		>
			Ver Relatório
		</a>
	</div>
