<div class="flex flex-col rounded-2xl bg-white p-4 shadow-sm gap-3">
  <h1 class="text-xl font-bold">Acesso Rápido</h1>

  <div class="grid grid-cols-3 gap-3">
    <a href="/chamada"
      class="flex flex-col items-center gap-2 rounded-xl border border-gray-100 bg-gray-50 p-4 transition-colors hover:border-red-200 hover:bg-red-50">
      ...
      <p class="text-sm font-semibold text-gray-700">Fazer Chamada</p>
    </a>
    ...
    <a href="/relatorio"
      ...
      <p class="text-sm font-semibold text-gray-700">Relatórios</p>
    </a>
    ...
    <a href="/importar"
      ...
      <p class="text-sm font-semibold text-gray-700">Importar Alunos</p>
    </a>
  </div>
</div>